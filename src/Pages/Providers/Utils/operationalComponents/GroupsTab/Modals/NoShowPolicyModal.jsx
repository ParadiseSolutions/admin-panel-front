...
import {
  createNoShowPolicy,
  getBaseOnGroupsOptionsAPI,
  getBaseOnOptionsAPI,
  getPaymentGroupsOptionsAPI,
  getPaymentOptionsAPI,
  getPolicyToEditAPI,
  updateCancellationPolicy,
  updateNoShowGroupPolicy,
...
const NoShowPolicyModal = ({
  ...
  useEffect(() => {
    getBaseOnGroupsOptionsAPI().then((res) => {
      setBaseOnData(res.data.data);
    });
    getPaymentGroupsOptionsAPI().then((res) => {
...
console.log(baseOnData, "baseOnData");
  ...
  const validationType = useFormik({
    ...
    onSubmit: (values) => {
      ...
      if (idEdit) {
        updateNoShowGroupPolicy(idEdit, data)
          .then((res) => {
