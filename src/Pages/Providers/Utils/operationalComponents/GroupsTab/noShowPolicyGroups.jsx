...
import { deletePolicyAPI, getNoShowPolicyGroupsAPI } from "../../../../../Utils/API/Providers";
import NoShowPolicyModal from "./Modals/NoShowPolicyModal";
import Swal from "sweetalert2";

const NoShowPolicyGroups = () => {
  const { id } = useParams();
  ...
  //initial request
  useEffect(() => {
    getNoShowPolicyGroupsAPI(id).then((res) => {
...
export default NoShowPolicyGroups;
