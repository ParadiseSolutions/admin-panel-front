...
const AddContactProviderModal = ({ addContactModal, setAddContactModal, onClickNewContactProvider }) => {
  const { id } = useParams();
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="modal-title mt-0 text-white">+ Add New Contact</h1>
        <button
          onClick={() => {
            setAddContactModal(false);
          }}
...
export default AddContactProviderModal;
