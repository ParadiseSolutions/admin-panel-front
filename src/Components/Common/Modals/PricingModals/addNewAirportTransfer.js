...
import {
  ...
  postPricesAPI,
  getPriceAPI,
  updatePriceAPI, getPricingZoneOptionsAPI,
  triggerUpdate,
...
const AddNewAirportTransfer = ({
  ...
  useEffect(() => {
    if (dataEdit && addNewAirportTransfer && priceCollect) {
      if (copyProduct) {
        setRecalc(true)
      } else {
        setRecalc(false)
        ...
        let data = {
          ...
          price_details: [
            ...
            },
            {
              ...
              min: !values.min || values.min === "" ? null : values.min,
              max: !values.max || values.max === "" ? null : values.max,
              label: null,
            },
            {
      ...
      >
        {copyProduct ? (
          <h1 className="modal-title mt-0 text-white">
            + Copy Product - Airport Transfer
          </h1>
        ) : null}
        {copyProduct === false && dataEdit ? (
          <h1 className="modal-title mt-0 text-white">
            + Edit Product - Airport Transfer
          </h1>
        ) : null}
        {copyProduct === false && !dataEdit ? (
          <h1 className="modal-title mt-0 text-white">
