                    ...
                    <div className="form-outline mb-2">
                      <div className="d-flex justify-content-between">
                        ...
                        <div>
                          ...
                          >
                            Specify the capacity of the boat. If it is up to 50
                            people same price, then leave the first box empty
                            and type 50 in the second box. If it is a tiered
                            pricing like 41 to 50 people for the specified
                            price, then you'll type 41 in the first box and 50
                            in the second box.
                          </Tooltip>
                        </div>
                      </div>
                          ...
                          <div className="d-flex justify-content-between">
                            ...
                            <div>
                              ...
                              >
                                ...
                                we pay a Net Rate and whatever we add to it is
                                our commission.
                                <br />
                                <br />
                                ...
                                <br />
                                <br />
                                Fixed Commission - When the Provider offers a
                                set commission for the product not based on a
                                Net Rate or a Commission Rate %, such as $100.00
                                no matter what the selling price is.
                                <br />
                                <br />
                                The exact details of these fields, such as if
                                they apply before or after taxes, gratuity, etc
                                is set up previously in the Payment Settings
                                tab.
                              </Tooltip>
                            </div>
                          </div>
                                ...
                                <div>
                                  ...
                                  >
                                    ...
                                    <p>
                                      ...
                                      agreement, and the tour or a comparable
                                      tour is not found anywhere on the
                                      internet, leave blank.
                                    </p>
                                  </Tooltip>
                                </div>
                              </div>
                              ...
                              <div className="d-flex justify-content-between">
                                ...
                                <div>
                                  ...
                                  >
                                    ...
                                    understand if the Provider is giving us a
                                    good deal or not.
                                  </Tooltip>
                                </div>
                              </div>
                              ...
                              <div className="d-flex justify-content-between">
                                ...
                                <div>
                                  ...
                                  >
                                    ...
                                    Provider is offering us. This is calculated
                                    as the difference between the Public Price
                                    and Net Price.
                                    <br />
                                    This is just informational for us to
                                    understand if the Provider is giving us a
                                ...
                                >
                                  <div className="d-flex justify-content-between">
                                    ...
                                    <div>
                                      ...
                                      >
                                        The base price of the product before
                                        taxes and gratuities are added on.
                                      </Tooltip>
                                    </div>
                                  </div>
                                  <div className="input-group">
                                ...
                                >
                                  <div className="d-flex justify-content-between">
                                    ...
                                    <div>
                                      ...
                                      >
                                        The amount of IVA (VAT) that is due to
                                  ...
                                  <div className="d-flex justify-content-between">
                                    ...
                                    <div>
                                      ...
                                      >
                                        ...
                                        required by the Provider to be
                                        collected.
                                        <br />
                                        <br />
                                        This is based on the Payment Settings.
                                        If "Unspecified" is chosen, then this
                                        field will be zero. Even though a
                                        gratuity is encouraged and expected, the
                                        Provider doesn't mandate what it is. The
                                        customer can decide on the day of the
                                        tour what gratuity they will give.
                                      </Tooltip>
                                    </div>
                                  </div>
                                  <div className="input-group">
                              ...
                              <div className="d-flex justify-content-between">
                                ...
                                <div>
                                  ...
                                  >
                                    ...
                                    specified in our service agreement. If only
                                    a Net Price is specified then leave blank.
                                  </Tooltip>
                                </div>
                              </div>
                              <div className="input-group">
                            ...
                            <div className="form-outline mb-2" id="rate">
                              <div className="d-flex justify-content-between">
                                ...
                                <div>
                                  ...
                                  >
                                    The Net Price shown on the Service
                                    Agreement. What it represents is specified
                                    on the Payment Settings tab.
                                  </Tooltip>
                                </div>
                              </div>
                              <div className="input-group">
                              ...
                              <div className="d-flex justify-content-between">
                                ...
                                <div>
                                  ...
                                  >
                                    ...
                                    This is automatically calculated based on
                                    the Net Price so no entry is required.
                                  </Tooltip>
                                </div>
                              </div>
                              <div className="input-group">
                            ...
                            <div className="form-outline mb-2" id="commission">
                              ...
                              <div className="input-group">
                                ...
                                <Input
                                  ...
                                  onChange={validationType.handleChange}
                                  value={
                                    validationType.values.p_commission || ""
                                  }
                                  onBlur={(e) => {
                                    const value = e.target.value || "";
                                    validationType.setFieldValue(
                              ...
                              <div className="d-flex justify-content-between">
                                ...
                                <div>
                                  ...
                                  >
                                    ...
                                    is just informational for us to understand
                                    if the Provider is giving us a good deal or
                                    not.
                                  </Tooltip>
                                </div>
                              </div>
