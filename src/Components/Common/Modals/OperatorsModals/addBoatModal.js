                      ...
                      <div className="d-flex align-items-center justify-content-between">
                        ...
                        <div>
                          ...
                          >
                            ...
                            than coordinates. Click "Share" to obtain the link.
                            Do not use the browser URL. Make sure to use only
                            the English version, and make sure that the specific
                            location where the customer will stand is selected.
                            Use map view not street view or terrain view for
                            this purpose.
                            <br />
                            <br />
                            Make sure the map is zoomed out at the default
                            setting and the directions button is visible.
                            Example: https://maps.app.goo.gl/hFFwJt7fmzjsRbc36
                            <br />
                            <br />
                            This will appear as a pin on the vouchers and
                            reminders for the customers to use to navigate to
                      ...
                      <div className="d-flex align-items-center justify-content-between">
                          ...
                          {imageLink && (
                            <>
                              ...
                              <UncontrolledTooltip
                                autohide={true}
                                placement="top"
                                target="t_boat_show_image_preview"
                              >
                                Show Preview
                              </UncontrolledTooltip>
                            </>
                        ...
                        <div>
                          ...
                          >
                            ...
                            avoid any confusion.
                            <br /> This will appear as a clickable link on the
                            voucher.
                          </UncontrolledTooltip>
                        </div>
                      </div>
